...
const Header = ({ isAuth, onOutClick, isAuthAdmin, changeAuthAdmin, isValueFilter, name, hidden, onHidden }) => {
   const handleClick =() => {
      onOutClick(false);
   ...
   return (
      <header>
         <div className="header">
            <Link to="/" className="header__link" onClick={handleHidden}>
            ...
            <div className="header__block">
               ...
               {isAuth && (<div className="username">{name}</div>)}
