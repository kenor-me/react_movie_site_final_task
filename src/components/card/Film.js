      ...
      <main>
         <section className="movie-information">
            ...
            <div className="movie-information__text-block text-block">
               ...
               <p className="text-block__genre">Adventure, Drama, Science Fiction </p>
               <p className="text-block__subtitle">About the film</p>
               <p className="text-block__reiting"><span>movie rating:</span>{film.vote_average}</p>
               ...
               <select className="add-vote-raiting" name="vote(raiting)">
                  <option className="add-vote--option" defaultValue>vote(raiting)</option>
